...
import { LocalizedShuffleTestimonials } from "@/components/localized-shuffle-testimonials"
import { LocalizedLandingFooter } from "@/components/localized-landing-footer"
...
export default function ChineseLanding() {
  ...
  return (
    <main id="main-content" className="min-h-screen" lang="zh-CN">
      <section
      ...
      >
        <AnimatedGridBackground className="min-h-screen flex-1" variant="light">
              ...
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center w-full">
                ...
                <div className="text-center lg:text-left space-y-6 md:space-y-8">
                  ...
                  <div className="flex lg:hidden justify-center my-8 scale-75">
                    <LocalizedShuffleTestimonials locale="cn" />
                  </div>
                  ...
                  >
                    {t.hero.description} <span className="text-blue-600 font-semibold">{t.hero.faster}</span>{" "}
                    {t.hero.and} <span className="text-emerald-600 font-semibold">{t.hero.errorFree}</span>
                  </motion.p>
                  ...
                  >
                    <LocalizedHomepageCtas locale="cn" />
                  </motion.div>
                </div>
          ...
          <LocalizedLandingFooter locale="cn" variant="light" />
