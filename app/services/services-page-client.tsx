      ...
      <section className="relative w-full bg-gradient-to-br from-slate-50 via-white to-sky-50/80">
        <AnimatedGridBackground className="flex flex-col" variant="light">
          ...
          <div className="w-full flex flex-col">
            ...
            <motion.footer
              className="py-8 md:py-10 border-t border-slate-200/60 bg-gradient-to-b from-transparent to-slate-50/80"
              variants={fadeInUp}
              initial="hidden"
              whileInView="visible"
            ...
            >
              <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
                {/* Footer Content - Compact 3 columns */}
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-6">
                  {/* Services Column */}
                  <div>
                    <h3 className="text-sm font-semibold text-slate-800 mb-3">Our Services</h3>
                    <ul className="space-y-1.5">
                      {serviceLinks.map((service, index) => (
                        <li key={index}>
                          <Link
                            href={service.href}
                            className="text-slate-500 hover:text-sky-600 transition-colors text-xs"
                          >
                            {service.name}
                          </Link>
                        </li>
                  ...
                  {/* Contact Column */}
                  <div>
                    <h3 className="text-sm font-semibold text-slate-800 mb-3">Contact</h3>
                  ...
                  {/* Language & Links Column */}
                  <div>
                    <h3 className="text-sm font-semibold text-slate-800 mb-3">PND50</h3>
                    <div className="relative inline-block mb-3">
                      ...
                      {langOpen && (
                        <div className="absolute bottom-full left-0 mb-1 bg-white rounded-md shadow-lg border border-slate-100 overflow-hidden min-w-[100px] z-50">
                          {languages.map((lang) => (
                            <Link
                              key={lang.code}
                              href={lang.href}
                              className="flex items-center gap-2 px-2 py-1.5 text-xs text-slate-600 hover:bg-slate-50 hover:text-sky-600 transition-colors"
                            >
                              <span>{lang.flag}</span>
                              <span>{lang.name}</span>
                            </Link>
                    ...
                    <div className="flex gap-4 text-xs">
                      <Link href="/privacy-policy" className="text-slate-500 hover:text-sky-600 transition-colors">
                        Privacy
                      </Link>
                      <Link href="/terms-of-service" className="text-slate-500 hover:text-sky-600 transition-colors">
                        Terms
                      </Link>
                    </div>
                  </div>
