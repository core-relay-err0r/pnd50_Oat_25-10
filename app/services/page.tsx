            ...
            <section className="py-16 md:py-32">
              <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Link
                    href="/contact"
                    className="inline-flex items-center justify-center gap-2 bg-white/5 border border-white/20 text-white px-8 py-4 rounded-lg font-semibold hover:border-primary hover:bg-white/10 transition-all"
                  >
                    Contact Us
                  </Link>
                </div>
