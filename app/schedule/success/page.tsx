          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12 pb-16">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6">
                <Button
                  asChild
                  className="flex-1 bg-gradient-to-r from-sky-500 to-blue-600 text-white hover:from-sky-600 hover:to-blue-700 hover:shadow-lg hover:shadow-sky-500/25 transition-all duration-200"
                >
                  <Link href="/">
                    <ArrowLeft className="mr-2 h-4 w-4" />
                    Back to Home
                ...
                <Button
                  asChild
                  variant="outline"
                  className="flex-1 border-sky-300 text-sky-700 bg-white/80 hover:border-sky-400 hover:text-sky-800 hover:bg-sky-50/80 transition-all duration-200"
                >
