      ...
      <main>
        <section className="relative w-full overflow-hidden bg-gradient-to-b from-neutral-900 via-neutral-800 to-neutral-900">
          <AnimatedGridBackground className="py-32 md:py-48">
            <div
              className="absolute top-20 left-10 w-96 h-96 bg-blue-600/20 rounded-full blur-3xl animate-float-slow animate-breathe pointer-events-none"
              style={{
            ...
            />
            <div
              className="absolute bottom-20 right-10 w-96 h-96 bg-emerald-600/20 rounded-full blur-3xl animate-float-slower animate-breathe pointer-events-none"
              style={{
                transform: `translate(${-mousePosition.x}px, ${-mousePosition.y}px)`,
                transition: "transform 0.5s ease-out",
              }}
            ...
            <div className="container mx-auto px-4 text-center relative z-10">
              <div
                className={`inline-flex items-center gap-2 rounded-full bg-white/10 backdrop-blur-md px-5 py-2 text-sm font-medium text-white mb-8 border border-white/20 transition-all duration-700 hover:bg-white/20 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/20 ${
              ...
              >
                Accounting Meets
                <br />
                <span className="bg-gradient-to-r from-blue-400 via-emerald-400 to-blue-400 bg-clip-text text-transparent animate-gradient-shift inline-block hover:scale-105 transition-transform duration-300">
                  Innovation
                </span>
              </h1>
                ...
                {[
                  {
                    icon: "🤖",
                    label: "AI-Powered",
                    color: "from-blue-500/20 to-blue-600/20 hover:from-blue-500/40 hover:to-blue-600/40",
                    hoverShadow: "hover:shadow-blue-500/50",
                  },
                  {
                    icon: "⚡",
                    label: "Real-Time Data",
                    color: "from-yellow-500/20 to-yellow-600/20 hover:from-yellow-500/40 hover:to-yellow-600/40",
                    hoverShadow: "hover:shadow-yellow-500/50",
                  },
                  {
                    icon: "🛡️",
                    label: "Secure & Compliant",
                    color: "from-emerald-500/20 to-emerald-600/20 hover:from-emerald-500/40 hover:to-emerald-600/40",
                    hoverShadow: "hover:shadow-emerald-500/50",
                  },
                  {
                    icon: "🌏",
                    label: "Expat Specialists",
                    color: "from-purple-500/20 to-purple-600/20 hover:from-purple-500/40 hover:to-purple-600/40",
                    hoverShadow: "hover:shadow-purple-500/50",
                  },
                ].map((feature, index) => (
                  <div
                    key={index}
                    className={`group flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r ${feature.color} backdrop-blur-md border border-white/20 transition-all duration-500 hover:scale-110 hover:shadow-2xl ${feature.hoverShadow} cursor-pointer hover:-translate-y-1 hover:rotate-1`}
                    style={{
        ...
        >
          <div className="absolute top-0 right-0 w-96 h-96 bg-blue-100 rounded-full blur-3xl opacity-30 animate-parallax"></div>
          <div
            className="absolute bottom-0 left-0 w-96 h-96 bg-emerald-100 rounded-full blur-3xl opacity-30 animate-parallax"
            style={{ animationDelay: "2s" }}
          ></div>

          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mb-20 scroll-animate">
              <p className="text-sm font-semibold text-blue-600 mb-3 tracking-wide uppercase animate-text-reveal">
                Our Services
              </p>
              <h2 className="text-4xl md:text-6xl font-bold text-neutral-900 mb-6 leading-tight hover:text-blue-600 transition-colors duration-300">
            ...
            <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
              {[
                ...
                <div
                  key={index}
                  className="scroll-animate group block p-8 md:p-10 border-2 border-neutral-200 rounded-2xl hover:border-blue-600 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-white hover-tilt relative overflow-hidden"
                  style={{
                ...
                >
                  ...
                  <div className="flex items-start gap-6 relative z-10">
                    <div className="text-6xl md:text-7xl font-bold text-neutral-200 group-hover:text-blue-600 transition-all duration-500 group-hover:scale-110 group-hover:rotate-3">
                      {service.number}
                    </div>
                    <div className="flex-1">
                      <div className="text-4xl mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 inline-block animate-float">
                        {service.icon}
                      </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="scroll-animate">
                ...
                <h2 className="text-4xl md:text-6xl font-bold text-neutral-900 mb-8 leading-tight hover:text-blue-600 transition-colors duration-300">
                ...
                <div className="space-y-8">
                  {[
                    ...
                    <div
                      key={index}
                      className="scroll-animate flex items-start gap-5 group transition-all duration-700 hover:translate-x-2"
                      style={{
                        transitionDelay: `${(index + 1) * 150}ms`,
                      }}
                    >
                      <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-blue-100 flex items-center justify-center text-2xl group-hover:scale-110 group-hover:bg-blue-600 group-hover:rotate-6 transition-all duration-500 animate-glow-pulse">
              ...
              <div className="scroll-animate-right relative">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-600/20 to-emerald-600/20 rounded-3xl blur-3xl animate-glow-pulse"></div>
                <div className="relative bg-neutral-900 rounded-3xl p-8 shadow-2xl border border-neutral-800 hover-tilt hover:shadow-blue-500/20 transition-all duration-500">
                  ...
                  <div className="space-y-6">
                    <div className="bg-neutral-800/50 backdrop-blur-sm rounded-xl p-6 border border-neutral-700 hover:border-blue-500 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20">
                      <h4 className="text-white font-semibold mb-4 flex items-center gap-2">
                        <span className="animate-bounce-in">📊</span> Document Status
                      </h4>
                      <div className="space-y-4">
                        {[
                          ...
                          <div key={index} className="group">
                            ...
                            <Progress
                              value={doc.progress}
                              className={`h-2 [&>*]:${doc.color} transition-all duration-500 group-hover:h-3`}
                            />
                          </div>
                        ))}
                      </div>
                    ...
                    <div className="bg-neutral-800/50 backdrop-blur-sm rounded-xl p-6 border border-neutral-700 hover:border-emerald-500 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/20">
                      <h4 className="text-white font-semibold mb-3 flex items-center gap-2">
                        <span className="animate-rotate-scale">🛡️</span> Security Status
                      </h4>
        ...
        >
          ...
          <div className="absolute top-10 left-10 w-64 h-64 bg-white/10 rounded-full blur-3xl animate-float-slow"></div>
          <div className="absolute bottom-10 right-10 w-64 h-64 bg-white/10 rounded-full blur-3xl animate-float-slower"></div>

          <div className="container mx-auto px-4 text-center relative z-10">
            <h2 className="scroll-animate text-4xl md:text-6xl font-bold text-white mb-6 leading-tight hover:scale-105 transition-transform duration-300">
            ...
            >
              {["Tech-Driven Automation", "Instant Reporting", "Expert Support", "Expat Specialists"].map(
                (feature, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-3 group hover:scale-110 transition-transform duration-300"
                    style={{ transitionDelay: `${index * 100}ms` }}
                  >
                    <svg
                      className="w-6 h-6 text-emerald-300 group-hover:rotate-12 group-hover:scale-125 transition-all duration-300"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
