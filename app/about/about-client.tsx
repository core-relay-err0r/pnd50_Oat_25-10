          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="scroll-animate opacity-0 translate-x-[-50px] transition-all duration-1000">
                ...
                <div className="mt-8 p-6 rounded-2xl bg-gradient-to-br from-primary/5 to-chart-2/5 border border-border">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="scroll-animate opacity-0 translate-x-[-50px] transition-all duration-1000">
                ...
                <div className="p-6 rounded-2xl bg-gradient-to-br from-primary/5 to-chart-2/5 border border-border">
              ...
              <div className="scroll-animate opacity-0 translate-x-[50px] transition-all duration-1000 delay-200 relative">
                <div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
                  ...
                  {/* Team stats overlay */}
                  <div className="absolute bottom-6 left-6 right-6 bg-background/90 backdrop-blur-md rounded-2xl p-6 border border-border">
