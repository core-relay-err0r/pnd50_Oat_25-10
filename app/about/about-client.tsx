        ...
        <AnimatedGridBackground className="min-h-screen flex-1">
          ...
          <div className="flex-1 w-full flex flex-col lg:scale-[0.85] lg:origin-top">
              ...
              <div className="container mx-auto px-4 sm:px-6 relative z-10 lg:px-0">
                ...
                <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                  ...
                  <div className="text-center lg:text-left">
                    ...
                    >
                      PND50 is an accounting and advisory firm based in Thailand, helping foreign-owned businesses
                  ...
                  <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="scroll-animate opacity-0 translate-y-[30px] sm:translate-x-[-50px] transition-all duration-1000 text-center lg:text-left flex flex-col justify-center min-w-0 w-full">
                      ...
                      <p className="sm:text-lg text-slate-300 mb-6 sm:mb-8 leading-relaxed break-words text-sm">
                        We believe that numbers should never cause confusion. Our approach is to make accounting simple
                        and transparent for foreign-owned businesses in Thailand.
                      </p>
                ...
                <div className="max-w-7xl mx-auto">
                  <div className="text-center mb-12 sm:mb-16">
                    ...
                    <p className="sm:text-lg text-slate-300 max-w-3xl mx-auto text-sm">
                      We&#39;re proud to support international startups — especially from Russia and Vietnam. Helping
                      them manage accounting, tax, and compliance with confidence in Thailand.
                    </p>
                  </div>
            ...
            <section className="py-8 md:py-12 relative overflow-hidden">
              ...
              <div className="absolute bottom-10 right-10 w-64 h-64 bg-chart-2/10 rounded-full blur-3xl"></div>
              ...
              <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                <p className="text-slate-300 max-w-3xl mx-auto mb-8 leading-relaxed md:text-lg text-lg">
