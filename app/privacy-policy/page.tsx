    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div>
        ...
        <ul>
          ...
          <li>
            <strong>Website</strong> refers to [Your Website Name], accessible from [Your Website URL]
          </li>
          <li>
        ...
        <p>
          ...
          <a href="https://www.privacypolicies.com/blog/cookie-consent/">Privacy Policies website</a>.
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>For business transfers:</strong> To evaluate or conduct a merger, divestiture, restructuring,
