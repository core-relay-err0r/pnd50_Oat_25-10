...
export default function Submit() {
  ...
  const hasAnySelection =
    hasAccountingData || hasCorporateData || hasConsultingData;
          ...
          <div className="container">
            <div className="max-w-xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Thank you for your submission. We'll review your request and
                reply with next steps within 1 business day.
              </p>
              ...
              <CardContent className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setContactInfo({ name: e.target.value })
                      }
                      required
                    />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(value) =>
                      setContactInfo({
                        preferredContact: value as "email" | "phone" | "whatsapp",
                      })
                    }
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setCompanyInfo({ registrationNumber: e.target.value })
                      }
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <span className="font-medium">
                          ฿{formatPrice(accountingResult!.totalMonthly)}
                        </span>
                      </div>
                      <div>
                        <span className="text-muted-foreground">Annual:</span>{" "}
                        <span className="font-medium">
                          ฿{formatPrice(accountingResult!.totalAnnual)}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="p-4 bg-muted/50 rounded-lg">
                    ...
                    <div className="mt-3 pt-3 border-t border-border flex justify-between text-sm font-medium">
                      ...
                      <span>
                        ฿
                        {formatPrice(
                          selectedCorporateServices.reduce(
                            (sum, s) => sum + s.price,
                            0
                          )
                        )}
                  ...
                  <div className="text-center py-8 text-muted-foreground">
                    ...
                    <div className="flex flex-wrap justify-center gap-2">
                      <Button variant="outline" size="sm" asChild>
                        <Link href="/accounting">Calculate accounting</Link>
                      </Button>
                      <Button variant="outline" size="sm" asChild>
                        <Link href="/corporate">Browse corporate</Link>
                      </Button>
                      <Button variant="outline" size="sm" asChild>
                        <Link href="/consulting">Browse consulting</Link>
                      </Button>
                    </div>
                  </div>
                )}
