...
export function CompanyReviewPopup({
  open,
  onOpenChange,
  onConfirm,
}: CompanyReviewPopupProps) {
  ...
  const calculateTotal = () => {
    ...
    if (financialEnglish)
      total += CORPORATE_PRICING.COMPANY_REVIEW_FINANCIAL_ENGLISH;
    return total;
  };
                ...
                <div className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setFinancialReview(checked as boolean)
                    }
                  />
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setEnglishVersion(checked as boolean)
                    }
                  />
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setFinancialEnglish(checked as boolean)
                    }
                  />
                  <Label
                    htmlFor="financial-english"
