...
export function RegisteredOfficePopup({
  open,
  onOpenChange,
  onConfirm,
}: RegisteredOfficePopupProps) {
  ...
  const calculateTotal = () => {
    ...
    if (physicalAssistance)
      total += CORPORATE_PRICING.PHYSICAL_OFFICE_ASSISTANCE;
    return total;
  };
                ...
                <div className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setVirtualAssistance(checked as boolean)
                    }
                  />
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setPhysicalAssistance(checked as boolean)
                    }
                  />
