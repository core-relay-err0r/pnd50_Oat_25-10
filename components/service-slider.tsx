          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                style={{ cursor: "grab" }}
              >
                <div className="group border border-border rounded-2xl p-6 md:p-8 h-full hover:shadow-2xl hover:border-primary/50 transition-all duration-300 flex flex-col bg-emerald-50">
                  {/* Icon */}
