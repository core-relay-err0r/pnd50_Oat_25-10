...
export default function LocalizedAboutPage({ locale }: LocalizedAboutPageProps) {
  ...
  const icons = [Target, CheckCircle2, Heart]
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 lg:px-0 max-w-7xl">
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              >
                <span className="text-slate-900">{t.about.title1}</span>
                <br />
                <span className="text-slate-900">{t.about.title2}</span>
                <br />
              ...
              >
                <Link href={`/${locale}/contact`} className="w-full sm:w-auto inline-block">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-600 hover:from-blue-600 hover:via-blue-700 hover:to-indigo-700 text-white px-8 text-lg font-bold rounded-xl shadow-lg shadow-blue-500/30 transition-all duration-300 flex items-center justify-center gap-2 border-0"
            ...
            >
              <div className="relative w-full max-w-[450px] md:max-w-[550px] lg:max-w-[600px] h-full mx-auto">
                ...
                <div className="absolute top-[12%] right-[8%] w-40 h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 rounded-full overflow-hidden border-4 border-white shadow-xl z-10">
                  <img
                ...
                <div className="absolute bottom-[8%] left-[12%] w-48 h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 rounded-full overflow-hidden border-4 border-white shadow-xl z-10">
                  <img
        ...
        <div className="container mx-auto relative z-10 max-w-6xl">
          ...
          >
            {[
              ...
              <motion.div
                key={index}
                className="group relative bg-white rounded-2xl p-6 sm:p-8 shadow-lg shadow-slate-100 border border-slate-100 hover:shadow-xl hover:shadow-sky-100/50 transition-all duration-300"
                variants={fadeInUp}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">{t.about.mission.description}</p>
              ...
              >
                {t.about.mission.points.map((item, index) => {
                  ...
                  const colors = ["sky", "teal", "blue"]
                  return (
                    <motion.div key={index} className="flex items-start gap-4 group" variants={fadeInUp}>
                      <div
                        className={`flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-${colors[index]}-100 to-${colors[index]}-50 flex items-center justify-center`}
                      >
                        <Icon className={`w-6 h-6 text-${colors[index]}-600`} />
                      </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-7xl mx-auto">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <p className="text-sm font-semibold text-sky-600 mb-3 tracking-wide uppercase">
                {t.about.testimonials.badge}
              </p>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900 mb-4 leading-tight">
                {t.about.testimonials.title}
              </h2>
              <p className="sm:text-lg text-slate-600 max-w-3xl mx-auto text-sm">{t.about.testimonials.description}</p>
            </motion.div>
