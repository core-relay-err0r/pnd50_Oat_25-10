...
const modules = [
  {
    ...
    description:
      "Choose the event (incorporation, director change, share transfer). Get scope + one-time price.",
    features: [
  ...
  },
  {
    ...
    title: "Accounting",
    description:
      "Calculate monthly + yearly cost while learning what's required.",
  ...
  },
  {
    ...
    title: "Consulting",
    description:
      "Choose the business problem. Get expected outcomes + price range.",
      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Choose your starting point. Each module guides you through the scope
            and shows you the cost.
          </p>
        </div>
