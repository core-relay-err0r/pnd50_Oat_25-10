        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">
              Transparent, predictable pricing. Base fee + add-ons based on your
              setup.
            </p>
          </div>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {formatUSD(PRICING.BASE_ACCOUNTING)}/month
                  </span>
                </div>
                ...
                <div className="flex justify-between text-sm text-muted-foreground">
                  ...
                  <span>
                    +{formatUSD(PRICING.PAYROLL_PER_EMPLOYEE)}/employee/month
                  </span>
                </div>
                <div className="flex justify-between text-sm text-muted-foreground">
            ...
            <div className="bg-muted/30 rounded-lg p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {formatUSD(PRICING.YEAR_END_STATEMENTS)}/year
                  </span>
                </div>
                <div className="flex justify-between text-sm text-muted-foreground">
            ...
            <div className="bg-muted/30 rounded-lg p-6">
              <h3 className="font-semibold text-lg mb-4">
                Corporate Services (One-time, USD)
              </h3>
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  <span>Company incorporation</span>
                  <span className="font-medium">
                    {formatUSD(CORPORATE_PRICING.INCORPORATION)}
                  </span>
                </div>
                <div className="flex justify-between text-sm text-muted-foreground">
