...
const steps = [
  {
    ...
    description:
      "Tell us about your company setup, team size, and operations. Takes about 2 minutes.",
  },
  {
    icon: FileSearch,
    number: "02",
    ...
    description:
      "See exactly what's required, what's recommended, and what you don't need. With clear pricing.",
  },
  {
    icon: Send,
    number: "03",
    ...
    description:
      "Your answers auto-fill the request form. Review and submit. We reply with next steps.",
  },
];
