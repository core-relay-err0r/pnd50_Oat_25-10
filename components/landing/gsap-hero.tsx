    ...
    <main className="min-h-screen" ref={containerRef}>
      <section className="relative w-full min-h-screen flex flex-col bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 overflow-hidden">
        <AnimatedGridBackground className="min-h-screen flex-1">
          ...
          <div
            ref={blob1Ref}
            className="absolute top-20 left-10 w-96 h-96 bg-primary/20 rounded-full blur-[100px] pointer-events-none mix-blend-screen"
          />
          <div
            ref={blob2Ref}
            className="absolute bottom-20 right-10 w-96 h-96 bg-chart-2/20 rounded-full blur-[100px] pointer-events-none mix-blend-screen"
          />
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex-1 flex items-center py-12 sm:py-16 lg:py-20 pt-[100px] lg:pt-12 pb-32 lg:pb-20">
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center w-full">
                ...
                <div className="text-center lg:text-left space-y-6 md:space-y-8">
                  <div className="hero-badge inline-flex items-center gap-2.5 rounded-full bg-gradient-to-r from-primary/10 to-chart-2/10 backdrop-blur-md px-6 py-3 text-sm font-semibold text-white mb-2 border border-primary/20 transition-all duration-300 hover:bg-primary/20 hover:border-primary/40">
                  ...
                  >
                    ...
                    <span className="relative inline-block w-full h-[1.15em] overflow-hidden" ref={wordsRef}>
                      {words.map((word, index) => (
                        <span
                          key={index}
                          className={`word-${index} absolute left-1/2 lg:left-0 -translate-x-1/2 lg:translate-x-0 text-white font-bold whitespace-nowrap ${
                  ...
                  <p className="hero-element text-base md:text-lg lg:text-xl max-w-2xl mx-auto lg:mx-0 leading-relaxed text-slate-300">
