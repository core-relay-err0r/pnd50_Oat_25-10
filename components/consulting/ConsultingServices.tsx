...
const SERVICES = [
  ...
  },
  {
    ...
    description:
      "Evaluate and plan market entry strategy for Thailand or ASEAN.",
  },
  {
    id: "due-diligence",
    icon: Search,
    ...
    description:
      "Comprehensive review of a target company or potential partner.",
  },
  {
    ...
    description:
      "Optimize your corporate structure for growth, tax, or liability.",
  },
  {
    id: "bank-compliance",
    icon: Building,
    ...
    description:
      "Prepare for bank account opening or compliance requirements.",
  },
];
...
export function ConsultingServices() {
  ...
  const isSelected = (id: string) =>
    selectedConsultingServices.some((s) => s.id === id);
              ...
              <CardContent className="space-y-4">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground/70">
                    ≈ ฿{formatPrice(service.priceRange.minTHB)}–฿
                    {formatPrice(service.priceRange.maxTHB)}
                  </p>
                </div>
          ...
          <div className="container flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <span className="font-medium">
                {selectedConsultingServices.length} problem(s) selected
              </span>
            </div>
