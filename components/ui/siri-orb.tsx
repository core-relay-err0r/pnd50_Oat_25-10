...
export const SiriOrb: React.FC<SiriOrbProps> = ({
  ...
  const defaultColors = {
    bg: "transparent",
    c1: "oklch(75% 0.18 220)", // Primary blue
    c2: "oklch(80% 0.15 200)", // Cyan
    c3: "oklch(78% 0.16 250)", // Purple-blue
  }

  const activeColors = {
    bg: "transparent",
    c1: "oklch(75% 0.22 140)", // Green
    c2: "oklch(80% 0.18 160)", // Teal
    c3: "oklch(78% 0.20 120)", // Lime green
  }

  const finalColors = isActive ? { ...activeColors, ...colors } : { ...defaultColors, ...colors }
  ...
  const speed = isActive ? animationDuration / 2 : animationDuration
