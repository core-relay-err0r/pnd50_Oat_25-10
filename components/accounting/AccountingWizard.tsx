...
export function AccountingWizard() {
  ...
  const { accountingInputs, setAccountingInputs, accountingResult } =
    useServices();
    ...
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <button
          type="button"
          onClick={() =>
            setInputs({ ...inputs, accountingIntent: "year-end-only" })
          }
          className={`p-6 rounded-lg border-2 text-left transition-all ${
      ...
      <p className="text-sm text-muted-foreground text-center">
        Most operating companies choose full accounting. Year-end only is used
        in specific cases.
      </p>
    </div>
  );
      ...
      <div>
        ...
        <RadioGroup
          ...
          onValueChange={(value) =>
            setInputs({
              ...inputs,
              revenueRange: value as AccountingInputs["revenueRange"],
            })
          }
      ...
      <div>
        ...
        <RadioGroup
          ...
          onValueChange={(value) =>
            setInputs({
              ...inputs,
              vatRegistered: value as AccountingInputs["vatRegistered"],
            })
          }
      ...
      <div>
        ...
        <div className="space-y-4">
          <Slider
            ...
            onValueChange={([value]) =>
              setInputs({ ...inputs, employeeCount: value })
            }
            max={30}
            step={1}
            className="w-full"
          ...
          <div className="flex justify-between text-sm text-muted-foreground">
            ...
            <span className="font-medium text-foreground">
              {inputs.employeeCount || 0} employees
            </span>
            <span>30</span>
          </div>
        </div>
          ...
          <div className="mt-6 p-4 bg-muted/30 rounded-lg space-y-3">
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium">
                Are these employees required for operations or visas?
              </span>
              <Tooltip>
                <TooltipTrigger>
                  <HelpCircle className="h-4 w-4 text-muted-foreground" />
                ...
                <TooltipContent className="max-w-xs">
                  Some companies formally employ staff for visa purposes. This
                  still affects payroll reporting.
                </TooltipContent>
              </Tooltip>
            </div>
            <RadioGroup
              ...
              onValueChange={(value) =>
                setInputs({
                  ...inputs,
                  employeePurpose: value as AccountingInputs["employeePurpose"],
                })
              }
        ...
        <div className="flex items-center space-x-4 p-4 border border-border rounded-lg">
          <Switch
            ...
            onCheckedChange={(checked) =>
              setInputs({ ...inputs, payrollNeeded: checked })
            }
          />
        ...
        <RadioGroup
          ...
          onValueChange={(value) =>
            setInputs({
              ...inputs,
              transactionVolume:
                value as AccountingInputs["transactionVolume"],
            })
          }
          className="grid gap-3"
        >
          {[
            {
              value: "low",
              label: "Low",
              description: "Less than 50 transactions/month",
            },
            {
              value: "medium",
              label: "Medium",
              description: "50–200 transactions/month",
            },
            {
              value: "high",
              label: "High",
              description: "More than 200 transactions/month",
            },
          ].map((option) => (
            <Label
              key={option.value}
      ...
      <div>
        ...
        <div className="flex items-center space-x-4 p-4 border border-border rounded-lg">
          <Switch
            ...
            onCheckedChange={(checked) =>
              setInputs({ ...inputs, internationalPayments: checked })
            }
          />
          <Label htmlFor="intl-payments" className="cursor-pointer">
            {inputs.internationalPayments
              ? "Yes, we have international payments"
        ...
        <RadioGroup
          ...
          onValueChange={(value) =>
            setInputs({
              ...inputs,
              yearEndStatements:
                value as AccountingInputs["yearEndStatements"],
            })
          }
          className="grid grid-cols-3 gap-3"
        >
      ...
      <div>
        ...
        <RadioGroup
          ...
          onValueChange={(value) =>
            setInputs({
              ...inputs,
              auditRequired: value as AccountingInputs["auditRequired"],
            })
          }
          className="grid grid-cols-3 gap-3"
        >
    ...
    <div className="space-y-8">
      <div className="text-center pb-6 border-b border-border">
        <h3 className="text-2xl font-bold mb-2">
          Your accounting setup overview
        </h3>
