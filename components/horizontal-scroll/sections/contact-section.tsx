...
export default function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({ name: "", email: "", phone: "", whatsapp: "", companyName: "", serviceType: "", message: "" })
      } else {
  ...
  const contactMethods = [
    { icon: Phone, label: "Call Us", value: "+66 2 017 2949", href: "tel:020172949", id: "phone" },
    { icon: Mail, label: "Email Us", value: "info@pnd50.com", href: "mailto:info@pnd50.com", id: "email" },
  ]

  return (
    <div className="w-full h-full min-h-screen overflow-y-auto bg-slate-50">
