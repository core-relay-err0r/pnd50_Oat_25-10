  ...
  return (
    <div className="w-full h-full min-h-screen overflow-y-auto">
      <section className="relative w-full min-h-screen bg-gradient-to-br from-slate-50 via-white to-sky-50/80">
        <AnimatedGridBackground className="flex-1 flex flex-col min-h-screen" variant="light">
          {/* Floating shapes */}
          <motion.div
          ...
          <div className="w-full flex flex-col py-8 pt-[100px]">
            ...
            >
              <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                <motion.div className="text-center mb-16" variants={fadeInUp} transition={{ duration: 0.5 }}>
